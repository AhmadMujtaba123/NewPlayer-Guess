...
float table(float x1,float batting_Avg_x2[],float y1 ,float bowling_Avg_y2[],float Distance[])
{
    int index;
    float result=0;
    float x2,y2;
...
int main()
{
    ...
    float label[11] = {1,0,1,2,0,1,2,0,0,2,0};         //0 for Batsman   1 for Bowler     2 for Allrounder.
    float Distance[11]={0};
    float order[11]={0};
    float result=0;
